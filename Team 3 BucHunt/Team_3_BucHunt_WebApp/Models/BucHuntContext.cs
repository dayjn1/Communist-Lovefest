...
* Class Purpose: BucHunt context generated by the scaffolding commands detailed in the project documentation<br>
* <hr>
...
public partial class BucHuntContext : DbContext
{
    ...
    //THIS CONNECTION STRING SHOULD BE REMOVED from this class
    //the connection string should be called from the appsettings.json file
    //everything else in the class should stay, but the connection string should not be hard coded
    //in the classes, the appsettings.json file is more protected and that is why it should only be in there
